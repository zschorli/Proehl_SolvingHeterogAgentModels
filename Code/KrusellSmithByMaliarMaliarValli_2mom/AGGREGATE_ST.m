...
function [kmts,kvarts,kcross_out]  = AGGREGATE_ST(T,idshock,agshock,km_max,km_min,kvar_max,kvar_min,kprime,km,kvar,k,epsilon2,k_min,k_max,kcross,a2);
...
for t=1:T
   ...
   kprimet4=interpn(k,km,kvar,a2,epsilon2,kprime,k, kmts_b(t),kvarts_b(t),agshock(t),epsilon2,'spline');
   ...
   kcross=kcrossn;
   if kmts(t)==kmts_b(t) && kvarts(t)==kvarts_b(t) 
      kcross_out = kcrossn;
   end
