...
function [kmts,kcross_out]  = AGGREGATE_ST(T,idshock,agshock,km_max,km_min,kprime,km,k,epsilon2,k_min,k_max,kcross,a2);
...
for t=1:T
   ...
   kprimet4=interpn(k,km,a2,epsilon2,kprime,k, kmts_b(t),agshock(t),epsilon2,'spline');
