...
dif_k=1;
   ...
   % Bad aggregate state and unemployed idiosyncratic state 
     ...
     k2prime_bu=interpn(k,km,kvar,kskew,kprime(:,:,:,:,1,1),kprime,kmprime,kvarprime,kskewprime,'spline'); 
   ...
   % Bad aggregate state and employed idiosyncratic state
     ...
     k2prime_be=interpn(k,km,kvar,kskew,kprime(:,:,:,:,1,2),kprime,kmprime,kvarprime,kskewprime,'spline');
   ...
   % Good aggregate state and unemployed idiosyncratic state
     ...
     k2prime_gu=interpn(k,km,kvar,kskew,kprime(:,:,:,:,2,1),kprime,kmprime,kvarprime,kskewprime,'spline');
   ...
   % Good aggregate state and employed idiosyncratic state
     ...
     k2prime_ge=interpn(k,km,kvar,kskew,kprime(:,:,:,:,2,2),kprime,kmprime,kvarprime,kskewprime,'spline');
