...
disp('Solving the individual and aggregate problem until ConvCrit<5e-5')%1e-6')
comp_time = tic;
while ConvCrit>5e-5%1e-6
...
save(strcat('DR_Sol',num2str(case_nr),'.mat'));
